...
This file lists all the formulas i know an learn

'''

def CoulombToNoOfElectron(coulomb):
    FinalAmount = int((coulomb)/(1.60218*10**-19))
    Length = len(str(FinalAmount))
    return f'{FinalAmount/(10**(Length-1))} 10e{Length-1}'


def ForceByChargesFinder(q1,q2,r):
    '''
        The technical formula is q1q2/4pi(epsilon)r^2
    '''
    return int(((q1*q2)*(8.98755*10**9))/r**2)

m= ForceByChargesFinder(2,5,1)
print(m)
